class RoutsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @rout.save
        format.html { redirect_to routs_url, notice: "Route was successfully created." }
      else
  ...
  def update
    respond_to do |format|
      if @rout.update(rout_params)
        format.html { redirect_to routs_url, notice: "Route was successfully updated." }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to routs_url, notice: "Route was successfully destroyed." }
    end
  end
